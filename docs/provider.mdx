...
| Model | Type | Description |
|---|---|---|
| `p-video` | Text-to-Video | Pruna's text-to-video model with audio synthesis |
| `wan-i2v` | Image-to-Video | Transform images into dynamic videos |
| `wan-t2v` | Text-to-Video | High-quality text-to-video generation |
| `vace` | Video Processing | Advanced video composition and effects |
